(function () {
    $(function () {
        ...
        var editUrl = "/Services/Edit";
        var detailUrl = "/Services/Details";
        var deleteUrl = "/Services/Delete";
        var searchUrl = "/Services/AjaxPage";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.result === okFlag) {
                            writeError("IndexAlerts", "Servicio eliminado correctamente", "success");
                            //$("#tableRowId" + id).remove();
                            refreshList();
                            abp.ui.clearBusy();
                        } else if (data.result < noneFlag) {
                            writeError("IndexAlerts", "Error al eliminar el Servicio", "error");
                            abp.ui.clearBusy();
                        }
                    }, error: function (xhr, ajaxOptions, thrownError) {
                        writeError("IndexAlerts", "¡Error al borrar el Servicio!", "error");
                        abp.ui.clearBusy();
                    }
                });
            } return false;
