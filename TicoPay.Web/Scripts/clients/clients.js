(function () {
    $(function () {
        ...
        var detailUrl = "/Clients/Details";
        var deleteUrl = "/Clients/Delete";
        var searchUrl = "/Clients/AjaxPage";
        ...
        function getRequest(url) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    writeError("msgErrorAnyModal", "¡Error al consultar los datos del Cliente!", "error");
                    abp.ui.clearBusy();
                }
            });
        }
        ...
        function refreshList() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    writeError("IndexAlerts", "¡Error al consultar los Clientes!", "error");
                    // abp.ui.clearBusy();
                }
            });
            return false;
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.result === okFlag) {
                            writeError("IndexAlerts", "Cliente eliminado correctamente", "success");
                            //$("#tableRowId" + id).remove();
                            refreshList();
                            abp.ui.clearBusy();
                        } else if (data.result < noneFlag) {
                            writeError("IndexAlerts", "Error al eliminar el Cliente", "error");
                            abp.ui.clearBusy();
                        }
                    }, error: function (xhr, ajaxOptions, thrownError) {
                        writeError("IndexAlerts", "¡Error al borrar el Cliente!", "error");
                        abp.ui.clearBusy();
                    }
                });
            } return false;
