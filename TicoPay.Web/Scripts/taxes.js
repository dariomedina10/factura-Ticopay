(function () {
    $(function () {
        ...
        var createUrl = "/Taxes/Create";
        var editUrl = "/Taxes/Edit";
        var detailUrl = "/Taxes/Details";
        var deleteUrl = "/Taxes/Delete";
        var searchUrl = "/Taxes/AjaxPage";
        ...
        function getRequest(url) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    writeError("msgErrorAnyModal", "¡Error al consultar los datos del Impuesto!", "error");
                    abp.ui.clearBusy();
                }
            });
        }
        ...
        //                writeError("IndexAlerts", "¡Error al consultar los Impuestos!", "error");
        //                // abp.ui.clearBusy();
        //            },
        //             complete: function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success == true) {
                            writeError("IndexAlerts", "Impuesto eliminado correctamente", "success");
                        ...
                        writeError("IndexAlerts", "¡Error al borrar el Impuesto!", "error");
                        abp.ui.clearBusy();
                    }
                });
            } return false;
